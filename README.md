...
- **성과**: 프로젝트를 통해 어린이들의 호기심을 충족시키는 동시에, 기술적 문제 해결 능력과 창의성을 키우는 데 크게 기여.
...
- **성과**: 서버와의 복잡한 통신 과정에 대한 경험, 실제 서비스 구현에 필요한 다양한 요소들에 대한 이해.
...
- **성과**:생성 AI의 중요성과 프롬프트가 결과물에 미치는 영향에 대한 이해.
...
- **성과**: AI를 활용한 포트폴리오 분석 및 가상 면접 시뮬레이션 구현
